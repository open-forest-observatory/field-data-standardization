...
# filter this massive dataset to 1. trees, that are 2. mapped, 3. have a stemDiameter ≥ 10 cm (smaller trees were not exhaustively sampled), and 4. have a height
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.21")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.23")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.41")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.39")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.25")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.43")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.61")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.59")
...
api_string <- paste0("https://data.neonscience.org/api/v0/locations/", plot_id_current, ".basePlot.vst.57")
...
# OH NO...API RATE LIMIT EXCEEDED halfway thru on SOAP 054
...
unique_treesinplots_final$ofo_plot_id[unique_treesinplots_final$NEONplotID == 'SJER_003'] <- '0119'
