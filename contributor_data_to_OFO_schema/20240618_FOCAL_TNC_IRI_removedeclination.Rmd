...
## Tree coords look wrong-- removing declination we previously added in to see if it solves the problem
...
for(i in 1:nrow(combinedtrees)) {
    combinedtrees[i,]$`TreeLongitudeUTM10N` = (combinedtrees[i,]$PlotLongitudeUTM10N) + ((sin(deg2rad(combinedtrees[i,]$Azimuth))) * ((combinedtrees[i,]$`All Horizontal Distances (m)`)))
}

# Latitude UTM10N

for(i in 1:nrow(combinedtrees)) {
    combinedtrees[i,]$`TreeLatitudeUTM10N` = (combinedtrees[i,]$PlotLatitudeUTM10N) + ((cos(deg2rad(combinedtrees[i,]$Azimuth))) * ((combinedtrees[i,]$`All Horizontal Distances (m)`)))
}
...
st_write(treecoordinatesconversion, data("C:\\Users\\emily\\Box\\FOCAL\\field-data-standardization\\TNC.IRI.Compiled.Data\\finaltreecoordinatesNODECLINATION.kml"),delete_dsn=TRUE)
...
write.csv(combinedtrees, "C:\\Users\\emily\\Box\\FOCAL\\field-data-standardization\\TNC.IRI.Compiled.Data\\20240618_IRItoOFO_ALLplots_NODECLINATION.csv")
...
write.csv(largeplots, "C:\\Users\\emily\\Box\\FOCAL\\field-data-standardization\\TNC.IRI.Compiled.Data\\20240618_IRItoOFO_largeplots_NODECLINATION.csv")
...
write.csv(smallplots, "C:\\Users\\emily\\Box\\FOCAL\\field-data-standardization\\TNC.IRI.Compiled.Data\\20240618_IRItoOFO_smallplots_NODECLINATION.csv")
