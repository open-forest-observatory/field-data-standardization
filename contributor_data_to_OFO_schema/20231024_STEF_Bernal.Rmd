...
trees$notes <- str_replace(trees$notes, "fallen", "REMOVE FROM DATA") # "other damages" code
trees$notes <- str_replace(trees$notes, "DND", "REMOVE FROM DATA") # DEAD AND DOWN,"other damages" code
