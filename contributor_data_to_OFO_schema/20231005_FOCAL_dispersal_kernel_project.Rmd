...
treedata = read.csv(data("C:\\Users\\emily\\Box\\FOCAL\\ofo-field-data\\1_received-data\\0004\\data\\stems_v3_aligned.csv"))
...
Just a note that there are no distances in the final OFO data sheet! This is because distances were measured from subplot centers to the face of the tree. Because no DBH measurements were taken in this dataset, we can't calculate distance to the pith.
...
write.csv(treedata, "C:\\Users\\emily\\Box\\FOCAL\\field-data-standardization\\FOCAL.dispersal.kernel.project\\20231005_FOCAL_dispersal_kernel_project.csv")
