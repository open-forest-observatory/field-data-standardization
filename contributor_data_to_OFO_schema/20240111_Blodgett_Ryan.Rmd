...
plot240 <- plot240 %>%
  add_column(plot_id_ofo = "0354")

plot350 <- plot350 %>%
  add_column(plot_id_ofo = "0355")

plot380 <- plot380 %>%
  add_column(plot_id_ofo = "0356")

plot400 <- plot400 %>%
  add_column(plot_id_ofo = "0357")
...
treesUTM10N$SPP[treesUTM10N$SPP == 'DW'] <- '202' # typo for doug fir probably, just one of these in the whole dataset
