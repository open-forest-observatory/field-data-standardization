...
OHDS_final <- OHDS_df %>%
  mutate(project_id = "0014",
    ...
    forest_type = case_when(
      plot_id %in% c("0270", "0273") ~ "201 - Douglas-fir", # added 0273
      plot_id %in% c("0272", "0271", "0274", "0275") ~ "301 - Western Hemlock", # added 0271, 0274, 0275 
      plot_id %in% c("0276") ~ "304 - Western Redcedar"), # added this
    canopy_cover = "",
    min_dbh = "5.0",
    min_dbh_live = "",
    min_dbh_ohvis = "",
