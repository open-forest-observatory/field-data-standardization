...
treeskeep <- c("SUBPLOT", "SPECIES", "CONDITION        (LI, ST, SN, LO)", "DECAY CLASS (ST, SN only)", "DBH (cm)", "TREE HEIGHT (m)", "HEIGHT TO LIVE FOLIAGE (m)", "HEIGHT TO DEAD BRANCH (m)", "DIST (m)", "AZIMUTH", "CROWN TO BASE HEIGHT (m)", "NOTES", "PlotCenterEasting", "PlotCenterNorthing","tree_lon", "tree_lat", "plot_id_ofo", "subplot_id_ofo" )
...
alldata <- alldata %>% rename ("CONDITION" = "CONDITION        (LI, ST, SN, LO)")

alldata$CONDITION[alldata$CONDITION == "NA"] <- NA
...
alldata <- alldata[complete.cases(alldata$CONDITION),]
